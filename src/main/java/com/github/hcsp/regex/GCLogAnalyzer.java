...
public class GCLogAnalyzer {
    ...
    public static List<GCActivity> parse(File gcLog) throws IOException {
        ...
        return GetGCActivitiesFromLines(lines);
    }

    private static List<GCActivity> GetGCActivitiesFromLines(List<String> lines) {
    ...
    private static GCActivity convertToGcActivity(Matcher matcher) {
        ...
        return new GCActivity(youngGenBefore,
                youngGenAfter,
                youngGenTotal,
                heapBefore,
                heapAfter,
